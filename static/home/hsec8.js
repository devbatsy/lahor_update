    ...
    return __c(
        ...
        [
            ...
            __c(
                ...
                [
                    __c(
                        'div',
                        {
                            style:`position:absolute;top:0;left:0;height:80%;width:70%;background-image:url("../assets/a1.jpg");background-position:center 0;`,
                            class:'thin_border'
            ...
            __c(
                'div',
                {
                    style:'height:80vw;max-height:400px;min-height:300px;min-width:300px;text-align:center;' + __sC['page3FloatText']({method:'add',style:{justifyContent:'flex-start',padding:'unset'}}),
