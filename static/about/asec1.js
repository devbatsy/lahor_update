...
__SYD.a_page_1_cont_text_cont_1 = () =>{
    return __c(
        ...
        [
            __SYD.text_lib_type_h1_glob({cnt:'LAHOR Luxury Apartments',size:__p(['a_page_1_cont','font'],'55px') === '55px' ? '18px' : '16px' , w:'900' , inject:'font-family:cursive;text-transform:capitalize;line-height:60px' , clr:'#b99d75' , cls:'drop_down_incoming_css_animation'}),
            __SYD.text_lib_type_h1_glob({cnt:'About The Hotel',size:__p(['a_page_1_cont','font'],'55px') , w:'500' , inject:'text-transform:capitalize;line-height:60px;max-width:900px;width:100%;animation-delay:.7s;' , clr:'inherit' ,cls:'rotateZ_incoming_css_animation'}),
        ]
    )
}
